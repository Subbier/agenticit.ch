    ...
    <div style="max-width:560px;margin:0 auto;padding:24px 16px;">
      ...
      <div style="background:#ffffff;border:1px solid #e6ecf3;border-top:none;border-radius:0 0 14px 14px;padding:28px;color:#16233B;font-size:15px;line-height:1.6;">
        ...
        <div style="text-align:center;margin:22px 0;">
          <a href="${bookingUrl}" style="display:inline-block;background:#2DA8FF;color:#ffffff;text-decoration:none;font-weight:700;font-size:15px;padding:13px 28px;border-radius:10px;">Direkt einen Termin vereinbaren</a>
        </div>
