...
const features = [
  {
    title: "Immer eine Antwort",
    href: "/ai-agents",
    description:
      "Ob Web, WhatsApp, Mail oder Telefon: jede Anfrage bekommt sofort eine passende, freundliche Antwort. Tag und Nacht.",
  ...
  },
  {
    ...
    href: "/excellence",
    description:
      "Egal, wo Ihr Kunde schreibt: das Gespräch bleibt nahtlos, nichts geht verloren.",
    demo: AnimatedPhoneDemo,
    size: "medium",
  },
  {
    title: "Termine wie von selbst",
    href: "#contact",
    description:
      "Verfügbarkeit prüfen, buchen, bestätigen – ganz ohne Ihr Zutun.",
    demo: AnimatedCalendarDemo,
    size: "medium",
  },
  {
    title: "Nichts bleibt liegen",
    href: "/excellence",
    description:
      "Jede Nachricht wird bearbeitet und beantwortet – Sie sehen nur das fertige Ergebnis, nicht die Arbeit dahinter.",
    demo: AnimatedEmailDemo,
    size: "large",
  },
  {
    title: "Die heissen Kontakte zuerst",
    href: "/excellence",
    description:
      "Wir erkennen, wer wirklich kaufen will, und reichen Ihnen die besten Kontakte mit allen Details weiter.",
    demo: AnimatedLeadsDemo,
    size: "medium",
  },
  {
    title: "Fügt sich in Ihre Welt ein",
    href: "/smart-apps",
    description:
      "Wir verbinden uns mit Ihren bestehenden Tools und ändern nichts an dem, was bei Ihnen schon läuft.",
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          >
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-slate-100 border border-slate-200 text-slate-700 text-sm font-medium mb-6">
              ...
              Im Hintergrund erledigt – Sie sehen nur das Ergebnis
            </div>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 text-balance mb-4 sm:mb-6">
              Im Hintergrund läuft alles weiter.{" "}
              <span className="bg-gradient-to-r from-slate-600 to-slate-400 bg-clip-text text-transparent">
                Sie merken nur das Ergebnis.
              </span>
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-3xl mx-auto font-light leading-relaxed">
              Während Sie verkaufen, beantworten wir Anfragen, vereinbaren Termine und bereiten Kontakte vor. Sie müssen
              nichts davon verstehen – Sie geniessen einfach das Ergebnis.
            </p>
          </div>
          ...
          >
            {features.map((feature, index) => {
              const CardContent = (
                <div className="bg-white rounded-2xl p-6 sm:p-8 h-full shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-slate-200 hover:border-emerald-300">
                  <div className="mb-6">
              ...
              const wrapperClasses = `group transition-all duration-1000 block ${feature.size === "large" ? "md:col-span-2" : ""}`
              const wrapperStyle = {
                transitionDelay: isVisible ? `${300 + index * 100}ms` : "0ms",
              }

              return feature.href && feature.href.startsWith("/") ? (
                <Link
                  key={index}
                  href={feature.href}
