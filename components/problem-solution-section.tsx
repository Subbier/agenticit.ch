...
export function ProblemSolutionSection() {
  ...
  const scrollToContact = () => {
    ...
    if (el) {
      ...
      window.scrollTo({ top: rect.top + currentScrollY - 100, behavior: "smooth" })
    }
  }
    ...
    <section ref={sectionRef} className="py-16 sm:py-24 px-4 relative z-10">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="group">
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 sm:p-8 h-full hover:bg-white/10 transition-all duration-500 hover:border-red-400/30">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-red-400">Worauf es ankommt</h3>
              </div>

              {/* Key Stat */}
              <div className="bg-red-500/10 backdrop-blur-sm border border-red-500/20 rounded-xl p-4 sm:p-6 mb-6">
                <div className="text-3xl sm:text-4xl font-bold text-red-400 mb-2">78 %</div>
                <p className="text-white/80 text-sm sm:text-base">
                  der Interessenten kaufen beim Anbieter, der als Erster für sie da ist – Tempo entscheidet.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-white/70 text-sm sm:text-base">
                    Die erste Antwort zählt am meisten – gerade nach Feierabend und am Wochenende.
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-red-400 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-white/70 text-sm sm:text-base">
                    Jede Anfrage bleibt sofort beantwortet, während Ihr Team im Tagesgeschäft ist.
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-red-400 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-white/70 text-sm sm:text-base">
                    So wird aus Aufmerksamkeit ein Gespräch – und aus Interesse ein Termin.
                  </p>
                </div>
              </div>
            </div>
          ...
          {/* Solution Card */}
          <div className="group">
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 sm:p-8 h-full hover:bg-white/10 transition-all duration-500 hover:border-emerald-400/30">
              <div className="flex items-center gap-3 mb-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <CheckCircle />
                  <p className="text-white/70 text-sm sm:text-base">
                    Lead-Qualifizierung und Terminbuchung in Sekunden statt Stunden.
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle />
                  <p className="text-white/70 text-sm sm:text-base">
                    Verschmilzt unsichtbar mit CRM, Kalender und Ihrer gesamten Datenbasis.
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle />
                  <p className="text-white/70 text-sm sm:text-base">
                    Dominiert alle Kanäle: Web, WhatsApp, Mail und Phone.
                  </p>
                </div>
              </div>
            </div>
        ...
        >
          <div className="text-center bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-4 sm:p-6 hover:bg-white/10 transition-all duration-300">
            <div className="text-2xl sm:text-3xl font-bold text-white mb-2">In Sekunden</div>
            <p className="text-white/70 text-xs sm:text-sm">bis zur ersten Antwort – Ihre Kunden fühlen sich sofort gut aufgehoben.</p>
          </div>
          <div className="text-center bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-4 sm:p-6 hover:bg-white/10 transition-all duration-300">
            <div className="text-2xl sm:text-3xl font-bold text-white mb-2">Rund um die Uhr</div>
            <p className="text-white/70 text-xs sm:text-sm">auch dann für Sie da, wenn längst Feierabend ist.</p>
          </div>
          <div className="text-center bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-4 sm:p-6 hover:bg-white/10 transition-all duration-300">
            <div className="text-2xl sm:text-3xl font-bold text-white mb-2">Nur warme Kontakte</div>
            <p className="text-white/70 text-xs sm:text-sm">Sie sprechen mit Menschen, die wirklich interessiert sind.</p>
          </div>
        </div>
        ...
        >
          <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-3 sm:mb-4 text-balance">
            Sehen, was bei Ihnen möglich ist
          </h3>
          <p className="text-sm sm:text-base md:text-lg text-white/70 mb-6 sm:mb-8 max-w-2xl mx-auto font-light leading-relaxed">
            In einem kurzen, unverbindlichen Gespräch zeigen wir Ihnen, wie warme Anfragen zu Ihnen kommen.
          </p>
          <Button
